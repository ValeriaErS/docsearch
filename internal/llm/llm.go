...
НЕ ПОКАЗЫВАЙ ПРОЦЕСС МЫШЛЕНИЯ! ТОЛЬКО ОТВЕТ!
НЕ ПИШИ "Here's a thinking process" или "Analyze User Input"!
...
Твой ответ (ТОЛЬКО НА РУССКОМ, БЕЗ РАССУЖДЕНИЙ):`, context, question)
