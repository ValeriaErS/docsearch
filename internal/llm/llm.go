...
Важное правило: ЕСЛИ В КОНТЕКСТЕ ЕСТЬ ОТВЕТ — ТЫ ОБЯЗАН ЕГО НАЙТИ!

Инструкция:
1. Внимательно прочитай ВЕСЬ контекст.
2. Найди в нем ответ на вопрос.
3. Если ответ найден — напиши его КРАТКО (2-3 предложения).
4. Если ответа нет — напиши: "В документации нет информации по этому вопросу."
5. В конце каждого абзаца укажи источник: [источник: имя_файла, страница N]
...
Твой ответ (ТОЛЬКО НА РУССКОМ):`, context, question)
